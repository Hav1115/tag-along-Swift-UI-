...
//                activeGroupView(group: currentGroup)
//            } else {
//                createGroupView
//            }
//        }
...
//            
//            Picker("Duration (minutes)", selection: $viewModel.selectedMinutes) {
//                ForEach(viewModel.timeIntervals, id: \.self) { minutes in
...
//                }
//                
//                Text("Time Remaining: \(formatTimeRemaining(group.timeRemaining))")
//                    .font(.headline)
